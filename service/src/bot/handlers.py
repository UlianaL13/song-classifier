...
@router.callback_query(lambda m: m.data in ['model_1', 'model_2', 'model_3', 'model_4']) 
...
async def voice_message_handler(message: Message):
    ...
    await message.answer (main_song_name)
